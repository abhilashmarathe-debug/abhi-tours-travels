...
export default function Loader({ onComplete }) {
  ...
  useEffect(() => {
    ...
    // 2. Flight ascends while coach cruises safely along the road below
  ...
  return (
    ...
    >
      {/* Crisp Daylight Gradient Atmosphere */}
      <div className="absolute inset-0 bg-gradient-to-b from-sky-50/70 via-white to-slate-50 pointer-events-none" />

      {/* Sunbeam Depth Aura */}
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[680px] h-[320px] bg-gradient-to-r from-sky-200/40 via-amber-100/40 to-blue-100/30 blur-3xl rounded-full pointer-events-none" />

      {/* Soft Aerial Vapor Clouds */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none opacity-50">
        <div
          className={`absolute top-16 left-12 w-96 h-12 bg-sky-100/70 blur-2xl rounded-full transition-transform duration-[3000ms] ${
            phase === 'takeoff' ? '-translate-x-32' : 'translate-x-0'
          }`}
        />
        <div
          className={`absolute top-40 right-16 w-80 h-14 bg-amber-100/60 blur-2xl rounded-full transition-transform duration-[3000ms] ${
            phase === 'takeoff' ? 'translate-x-28' : 'translate-x-0'
          }`}
        />
      </div>
            ...
            <div className="relative drop-shadow-[0_16px_22px_rgba(15,23,42,0.18)]">
              ...
              >
                <defs>
                  ...
                  {/* Primary High-Gloss Sapphire Wings */}
                ...
                {/* Vertical Stabilizer Tail Fin with Gold Livery */}
          ...
          <div className="relative flex items-center">
            ...
            <div className="relative drop-shadow-[0_12px_18px_rgba(15,23,42,0.22)]">
              ...
              >
                ...
                {/* Aerodynamic Coach Body (Facing Left) */}
                <path
                ...
                {/* Upper Deck Sleeper Panoramic Glass */}
